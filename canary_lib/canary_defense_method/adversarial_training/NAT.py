...
@sefi_component.defense_class(defense_name="NAT")
@sefi_component.config_params_handler(handler_target=ComponentType.DEFENSE, name="NAT",
...
class NAT:
    def __init__(self, lr=0.01, momentum=0.9, weight_decay=3.5e-3, epochs=10, run_device=None, step_size=0.007,
                 epsilon=0.031, num_steps=10, log_interval=5):
    ...
    @sefi_component.defense(name="NAT", is_inclass=True, support_model=[])
    def defense(self, defense_model, train_dataset, val_dataset, each_epoch_finish_callback=None):
        ...
        for epoch in range(1, self.epochs + 1):
            ...
            if epoch % self.log_interval == 0:
                ...
                file_name = "AT_" + "NAT" + '_' + model_name + "_" + str(epoch) + ".pt"
                save_weight_to_temp(model_name=model_name, defense_name="NAT", epoch_cursor=str(epoch), file_path=model_name + '/NAT/',
    ...
    def madry_loss(self, model, x_natural, y, optimizer, step_size=0.003, epsilon=0.031, perturb_steps=10, distance='l_inf'):
