...
def densenet121_fix(*, weights: Optional[DenseNet121_Weights] = None, progress: bool = True, **kwargs: Any) -> DenseNet:
...
def densenet161_fix(*, weights: Optional[DenseNet161_Weights] = None, progress: bool = True, **kwargs: Any) -> DenseNet:
...
def densenet169_fix(*, weights: Optional[DenseNet169_Weights] = None, progress: bool = True, **kwargs: Any) -> DenseNet:
...
def densenet201_fix(*, weights: Optional[DenseNet201_Weights] = None, progress: bool = True, **kwargs: Any) -> DenseNet:
...
model_urls = _ModelURLs(
    {
        "densenet121_fix": DenseNet121_Weights.IMAGENET1K_V1.url,
        "densenet169_fix": DenseNet169_Weights.IMAGENET1K_V1.url,
        "densenet201_fix": DenseNet201_Weights.IMAGENET1K_V1.url,
        "densenet161_fix": DenseNet161_Weights.IMAGENET1K_V1.url,
    }
)