...
@sefi_component.util(util_type=SubComponentType.IMG_PREPROCESSOR, util_target=ComponentType.MODEL,
                     name=["Alexnet(ImageNet)", "ConvNext(ImageNet)", "DenseNet(ImageNet)", "EfficientNet(ImageNet)",
                           "EfficientNetV2(ImageNet)", "GoogLeNet(ImageNet)", "InceptionV3(ImageNet)",
                           "MNASNet(ImageNet)", "MobileNetV2(ImageNet)", "MobileNetV3(ImageNet)",
                           "RegNet(ImageNet)", "ResNet(ImageNet)", "ResNeXt(ImageNet)", "ShuffleNetV2(ImageNet)",
                           "SqueezeNet(ImageNet)", "SwinTransformer(ImageNet)", "VGG(ImageNet)", "ViT(ImageNet)",
                           "WideResNet(ImageNet)"])
