...
def resnet18(pretrained=False, pretrained_file=None, progress=True, device="cpu", **kwargs):
    ...
    """
    return _resnet(
        "resnet18", BasicBlock, [2, 2, 2, 2], pretrained, pretrained_file, progress, device, **kwargs
    )
