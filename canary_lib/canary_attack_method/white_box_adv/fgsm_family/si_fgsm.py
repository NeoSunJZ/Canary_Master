...
@sefi_component.attacker_class(attack_name="SIM", perturbation_budget_var_name="epsilon")
@sefi_component.config_params_handler(
    handler_target=ComponentType.ATTACK, name="SIM",
...
class SIM():
    ...
    @sefi_component.attack(name="SIM", is_inclass=True, support_model=[], attack_type="WHITE_BOX")
