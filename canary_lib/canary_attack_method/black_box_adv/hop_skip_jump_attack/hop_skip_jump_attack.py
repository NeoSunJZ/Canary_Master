...
from canary_lib.canary_attack_method.black_box_adv.hop_skip_jump_attack.hop_skip_jump_attack_core import HopSkipJumpAttack as FoolBoxHopSkipJumpAttack
