...
@sefi_component.util(util_type=SubComponentType.DATASET_LOADER, util_target=ComponentType.DATASET, name="FashionMNIST")
def dataset_getter(dataset_path, dataset_seed, dataset_size=None):
    dataset = torchvision.datasets.FashionMNIST(root=dataset_path, train=False, download=True)
