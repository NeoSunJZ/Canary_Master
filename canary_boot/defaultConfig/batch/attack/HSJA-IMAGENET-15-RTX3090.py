config = {
    "adv_example_generate_batch_config": {
        "HopSkipJumpAttack": {  # 3090:24G
            "Alexnet(ImageNet)": 50,  # ~8G 3090:65%
            "VGG(ImageNet)": 50,  # ~19G 3090:95%
            "GoogLeNet(ImageNet)": 80,  # ~10G 3090:85%
            "InceptionV3(ImageNet)": 20,  # ~7G 3090:90%
            "ResNet(ImageNet)": 50,  # ~11G 3090:90%
            "DenseNet(ImageNet)": 35,  # ~19G 3090:90%
            "SqueezeNet(ImageNet)": 50,  # ~12G 3090:80%
            "MobileNetV3(ImageNet)": 50,  # ~11G 3090:80%
            "ShuffleNetV2(ImageNet)": 50,  # ~10G 3090:80%
