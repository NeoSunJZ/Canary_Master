...
@sefi_component.model(name="Alexnet")
def create_model():
...
@sefi_component.util(util_type="result_postprocessor", util_target="model", name="Alexnet")
...
@sefi_component.inference_detector(model_name="Alexnet", support_type="numpy_array",
