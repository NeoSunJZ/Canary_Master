...
@sefi_component.util(util_type="img_preprocessor", util_target="model", name="VGG-16(ImageNet)")
...
@sefi_component.util(util_type="img_reverse_processor", util_target="model", name="VGG-16(ImageNet)")
...
@sefi_component.util(util_type="result_postprocessor", util_target="model", name="VGG-16(ImageNet)")
...
@sefi_component.inference_detector(model_name="VGG-16(ImageNet)", support_type="numpy_array",
