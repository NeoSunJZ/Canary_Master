    ...
    def defense(self, defense_model, train_dataset, val_dataset, each_epoch_finish_callback=None):
        ...
        for epoch in range(1, self.epochs + 1):
            ...
            if epoch % self.log_interval == 0:
                ...
                file_name = "AT_" + "NAT" + '_' + model_name + "_" + "CIFAR-10" + "_" + task_manager.task_token + "_" + str(
                    epoch) + ".pt"
                save_weight_to_temp(file_path=model_name + '/NAT/', file_name=file_name, weight=defense_model.state_dict())
