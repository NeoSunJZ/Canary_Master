...
@sefi_component.config_params_handler(handler_target=ComponentType.ATTACK, name="GA",
                                      ...
                                      params={
                                          ...
                                          "steps": {"desc": "迭代攻击轮数", "type": "INT", "def": "1000"},
                                          "population": {"desc": "种群", "type": "INT", "def": "10"},
                                          "mutation_probability": {"desc": "突变概率", "type": "FLOAT", "def": "0.10"},
                                          "mutation_range": {"desc": "突变范围", "type": "FLOAT", "def": "0.15"},
                                          "sampling_temperature": {"desc": "采样温度", "type": "FLOAT", "def": "0.3"},
                                          "channel_axis": {"desc": "通道轴", "type": "INT", "def": "None"},
                                          "reduced_dims": {"type": "Tuple[int,int]", "def": "None"}})
class GA():
    def __init__(self, model, epsilon=0.03, attacktype='TARGETED', tlabel=1, steps=1000, population=10, mutation_probability=0.10,
        ...
        self.steps = steps  # 整型
        self.population = population  # 种群 整型
        ...
        self.channel_axis = channel_axis  # 通道轴 整型
    ...
    def attack(self, img, ori_label):
        ...
        if self.attacktype == 'UNTARGETED':
            ...
            raw, clipped, is_adv = attack(fmodel, img, criterion=criterion, epsilons=self.epsilon)
