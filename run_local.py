...
if __name__ == "__main__":
    config = {"dataset_size": 10, "dataset": "ILSVRC-2012",
              ...
              "inference_batch_config": {
                  "VGG(ImageNet)": 10,  # ~19G 3090:95%
                  "MobileNetV3(ImageNet)": 10,  # ~11G 3090:80%
              },
    ...
    # global_recovery.start_recovery_mode(task_token="NxmXO0yQ")
    security_evaluation = SecurityEvaluation(config)
    security_evaluation.attack_full_test(use_img_file=True)
